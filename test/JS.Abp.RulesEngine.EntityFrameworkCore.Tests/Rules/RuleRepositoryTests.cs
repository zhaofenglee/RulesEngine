...
{
    public class RuleRepositoryTests : RulesEngineEntityFrameworkCoreTestBase
    {
        private readonly IRuleRepository _ruleRepository;

        public RuleRepositoryTests()
        {
            _ruleRepository = GetRequiredService<IRuleRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _ruleRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("60342e5a-dc76-47a3-9cb1-8a1eb19341cb"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _ruleRepository.GetCountAsync(
